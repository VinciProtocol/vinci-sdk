[Home](./index.md) &gt; [@vinci-protocol/api](./api.md) &gt; [NftService](./api.nftservice.md) &gt; [getNftsByWalletApiNftsByWalletGet](./api.nftservice.getnftsbywalletapinftsbywalletget.md)
